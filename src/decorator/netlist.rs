    ...
    Self::D: NetlistBase,
{
    ...
    fn d_for_each_pin<F>(&self, circuit: &<Self::D as HierarchyBase>::CellId, f: F)
    where
    ...
    fn d_for_each_internal_net<F>(&self, circuit: &<Self::D as HierarchyBase>::CellId, f: F)
    where
        F: FnMut(<Self::D as NetlistBase>::NetId) -> (),
    {
    ...
    fn d_for_each_pin_of_net<F>(&self, net: &<Self::D as NetlistBase>::NetId, f: F)
    where
        F: FnMut(<Self::D as NetlistBase>::PinId) -> (),
    {
    ...
    fn d_for_each_pin_instance_of_net<F>(&self, net: &<Self::D as NetlistBase>::NetId, f: F)
    where
        F: FnMut(<Self::D as NetlistBase>::PinInstId) -> (),
    {
